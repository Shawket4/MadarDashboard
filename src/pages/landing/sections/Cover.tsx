    ...
    <Page>
      <div className="absolute inset-0 flex flex-col px-20 py-16">
        <header className="flex items-start justify-between">
          ...
          <span className="text-[10px] tracking-[0.32em] uppercase text-navy/50 font-medium pt-1 tabular">
            {t("meta.publication")} · {meta.year}
          </span>
        </header>

        <div className="flex-1 flex flex-col justify-center max-w-[900px]">
          <p className="text-[10px] tracking-[0.36em] uppercase text-terracotta font-semibold mb-9">
            {t("cover.eyebrow")}
          </p>
        ...
        <footer className="flex items-end justify-between gap-16">
          ...
          <div className="flex items-center gap-2.5 text-[10px] tracking-[0.32em] uppercase text-navy/55 font-medium shrink-0">
