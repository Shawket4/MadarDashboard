...
export default function CashMovementFeature({ pageIndex }: { pageIndex: number }) {
        ...
        <div className="flex-1 grid grid-cols-12 gap-12 mt-10">
          <div className="col-span-5 flex flex-col justify-center pl-8">
            <h2 className="font-bold text-navy text-[36px] leading-[1.05] tracking-[-0.02em] mb-6 whitespace-pre-line">
              {t("featureCashMovement.title")}
            </h2>
            <p className="text-[14px] text-navy/65 leading-[1.65] mb-8">
              {t("featureCashMovement.body")}
            </p>
                ...
                <div key={k} className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-navy text-[13.5px] mb-1 tracking-[-0.005em]">
                      {t(`featureCashMovement.details.${k}.title`)}
                    </h4>
                    <p className="text-[12.5px] text-navy/60 leading-[1.55]">
                      {t(`featureCashMovement.details.${k}.body`)}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="col-span-7 flex flex-col justify-center">
            <IPad src="/screenshots/cash-movements.png" className="w-full" />
          </div>
        </div>
