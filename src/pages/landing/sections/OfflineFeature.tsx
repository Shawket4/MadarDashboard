...
export default function OfflineFeature({ pageIndex }: { pageIndex: number }) {
                ...
                <div key={k} className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-navy text-[13.5px] mb-1 tracking-[-0.005em]">
                      {t(`featureOffline.details.${k}.title`)}
                    </h4>
                    <p className="text-[12.5px] text-navy/60 leading-[1.55]">
                      {t(`featureOffline.details.${k}.body`)}
                    </p>
                  </div>
                </div>
              ))}
