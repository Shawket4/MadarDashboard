...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    fallback: "Reports",
    entries: [
      { to: "/reports/operations", labelKey: "nav.reportsOperations", fallback: "Operations", icon: TrendingUp },
      { to: "/reports/financial", labelKey: "nav.reportsFinancial", fallback: "Financial", icon: Coins, roles: ["org_admin", "super_admin"] },
