...
import { Bike, Coins, Receipt, Store, Truck, TrendingUp } from "lucide-react";
 ...
 * `DeliverySalesReport` (via `useBranchDeliverySales`) and passes it in.
 * Quiet cards: the glyph is a muted mark, and the only tint is a cancellation
 * count, which means something.
 */
