...
export const getPublicMenuResponseDeliveryMenuDiscountMock = (overrideResponse: Partial<DeliveryMenuDiscount> = {}): DeliveryMenuDiscount => ({...{dtype: faker.string.alpha({length: {min: 10, max: 20}}), id: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 20}}), name_translations: {}, value: faker.number.float({fractionDigits: 2})}, ...overrideResponse});
...
export const getPublicTableMenuResponseDeliveryMenuDiscountMock = (overrideResponse: Partial<DeliveryMenuDiscount> = {}): DeliveryMenuDiscount => ({...{dtype: faker.string.alpha({length: {min: 10, max: 20}}), id: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 20}}), name_translations: {}, value: faker.number.float({fractionDigits: 2})}, ...overrideResponse});
