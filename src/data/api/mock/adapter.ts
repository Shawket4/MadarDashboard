...
const RULES: Rule[] = [
  ...
  { test: /\/reports\/branches\/[^/]+\/sales\/peak-days/, data: MOCK_PEAK_DAYS },
  ...
  { test: /\/public\/delivery-orders\/past-locations/, method: "get", data: [
    ...
    { branch_id: "br_zamalek", channel: "in_mall", address_line: null, place_name: "Madar Coffee", floor: "2", unit_number: "Unit 14", landmark: "Near the main entrance", customer_lat: 30.063, customer_lng: 31.217, last_used_at: "2026-06-08T11:00:00Z" },
  ] },
