    ...
    () => [
      {
        ...
        cell: ({ row }) => (
          <span className="flex items-center gap-2">
            <span className="font-medium">{row.original.order_ref ?? `#${row.original.order_number}`}</span>
      ...
      { accessorKey: "teller_name", header: t("shifts.teller", "Teller"), meta: { label: t("shifts.teller", "Teller") } },
      {
        accessorKey: "waiter_name",
        header: t("shifts.waiter", "Waiter"),
        meta: { label: t("shifts.waiter", "Waiter") },
