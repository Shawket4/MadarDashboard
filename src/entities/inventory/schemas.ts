...
import { egpToPiastresNullable } from "@/shared/lib/zod-utils";
...
export const catalogSchema = z.object({
  ...
  // FIX: was sending the EGP input raw — backend stores piastres, so every
  // ingredient cost arrived 100× too small and corrupted the cost engine
  cost_per_unit: egpToPiastresNullable,
